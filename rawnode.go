...
// details.
func (rn *RawNode) ProposeConfChange(cc raftpb.ConfChangeI) error {
...
func (rn *RawNode) ApplyConfChange(cc raftpb.ConfChangeI) *raftpb.ConfState {
...
func newStorageAppendMsg(r *raft, rd Ready) raftpb.Message {
	m := raftpb.Message{
...
// storage.
func newStorageAppendRespMsg(r *raft, rd Ready) raftpb.Message {
	m := raftpb.Message{
...
func newStorageApplyMsg(r *raft, rd Ready) raftpb.Message {
...
func newStorageApplyRespMsg(r *raft, ents []raftpb.Entry) raftpb.Message {
	return raftpb.Message{
...
func (rn *RawNode) Advance(_ Ready) {
	...
	for i, m := range rn.stepsOnAdvance {
		_ = rn.raft.Step(m)
		rn.stepsOnAdvance[i] = raftpb.Message{}
	}
...
func (rn *RawNode) ReportUnreachable(id uint64) {
	_ = rn.raft.Step(raftpb.Message{Type: raftpb.MsgUnreachable, From: id})
}
...
func (rn *RawNode) ReportSnapshot(id uint64, status SnapshotStatus) {
	...
	_ = rn.raft.Step(raftpb.Message{Type: raftpb.MsgSnapStatus, From: id, Reject: rej})
}

// TransferLeader tries to transfer leadership to the given transferee.
func (rn *RawNode) TransferLeader(transferee uint64) {
	_ = rn.raft.Step(raftpb.Message{Type: raftpb.MsgTransferLeader, From: transferee})
}
...
func (rn *RawNode) ForgetLeader() error {
	return rn.raft.Step(raftpb.Message{Type: raftpb.MsgForgetLeader})
}
...
func (rn *RawNode) ReadIndex(rctx []byte) {
	_ = rn.raft.Step(raftpb.Message{Type: raftpb.MsgReadIndex, Entries: []raftpb.Entry{{Data: rctx}}})
}
